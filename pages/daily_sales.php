...
$daily_sales_data = $stmt_paginated->fetchAll(PDO::FETCH_ASSOC);
...
<link rel="stylesheet" href="../lib/monthly_daily_sales/daily.css">
...
<main class="main container" id="main">
    ...
    <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover" style="text-align: center; vertical-align: middle;">
                ...
                <tbody>
                    <?php if (!empty($daily_sales_data)): ?>
                        <?php foreach ($daily_sales_data as $index => $sale): ?>
                            <tr>
                                <td class="text-center"><?= $offset + $index + 1 ?></td>
                                <td><?= htmlspecialchars($sale['day']) ?></td>
        ...
        <!-- Pagination -->
        <div class="clearfix">
            <div class="hint-text">Showing <b><?= count($daily_sales_data) ?></b> out of <b><?= $totalItems ?></b>
                Items</div>
            <ul class="pagination">
